...
Class NemPhp extends NemApi{
    ...
    public function prepareTransaction($amount, $fee, $recipient, $mosaics = null, $message = null, $secure = false, $extractFeeFromTransaction = false){
        ...
        $timestamp = $this->timestampNEM();
        $this->transaction = [
            'timeStamp'     => $timestamp,           // The number of seconds elapsed since the creation of the nemesis block.
            ...
            'type'          => 257 ,
            'deadline'      => $timestamp + (60 * 60 * 2), // Remittance deadline
    ...
    public function announceTransaction(){
        return $this->requestAnnounce();
    }
